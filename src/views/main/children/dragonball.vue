<template>
    <div class="w-[90vw] ml-[5vw] mt-[2vw] text-[2.5vw] h-[20vw] wrapper"  ref="wrapper">
        <div class="flex w-[210vw] relative">
            <span class="absolute top-[6vw] left-[29vw] text-white text-[4vw] font-black" v-if="this.auth.anonimousUser">{{ dates }}</span>
            <span class="absolute top-[7vw] left-[7vw] text-white text-[4vw] font-black" v-else>{{ dates }}</span>
